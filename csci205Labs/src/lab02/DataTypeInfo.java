...
public class DataTypeInfo {
	...
	double minDouble = Double.MIN_VALUE, maxDouble = Double.MAX_VALUE;
        System.out.println("The minimum float value is " + minDouble);
        System.out.println("The maximum float value is " + maxDouble);
        System.out.println("The size of float is " + Double.SIZE);

	long minLong = Long.MIN_VALUE, maxLong = Long.MAX_VALUE;
        System.out.println("The minimum float value is " + minLong);
        System.out.println("The maximum float value is " + maxLong);
        System.out.println("The size of float is " + Long.SIZE);
    }
}
